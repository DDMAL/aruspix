/////////////////////////////////////////////////////////////////////////////
// Name:        mussvg.h (original name: dcsvg.h)
// Purpose:     SVG sample
...
#ifndef __MUS_SVG_H__
#define __MUS_SVG_H__

#ifdef __GNUG__
    #pragma interface "mussvg.cpp"    
#endif
...
class MusSVGFileDC : public wxDC
{
    ...
    private:
        ...
        void DoCrossHair(wxCoord, wxCoord)
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::CrossHair Call not implemented")); return  ; };
        ...
        bool DoFloodFill(wxCoord WXUNUSED(x), wxCoord WXUNUSED(y), const wxColour& WXUNUSED(col),
            ...
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::DoFloodFill Call not implemented")); return false ; };
...
#undef YLOG2DEVREL
    ...
    public:
        ...
        MusSVGFileDC (wxString f);
        MusSVGFileDC (wxString f, int Width, int Height);
        MusSVGFileDC (wxString f, int Width, int Height, float dpi);
        ~MusSVGFileDC();

        bool ConcatFile( wxString filename );
        ...
        int GetDepth() const
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::GetDepth Call not implemented")); return -1 ; };
        ...
        void Clear()
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::Clear() Call not implemented \nNot sensible for an output file?")); return ; };
        ...
        void DestroyClippingRegion()
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::void Call not yet implemented")); return ; };
        ...
        void GetClippingBox(wxCoord *WXUNUSED(x), wxCoord *WXUNUSED(y), wxCoord * WXUNUSED(width), wxCoord * WXUNUSED(height))
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::GetClippingBox Call not yet implemented")); return ; };

        int GetLogicalFunction()
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::GetLogicalFunction()  Call not implemented")); return wxCOPY ; };
        ...
        void SetClippingRegion(wxCoord  WXUNUSED(x), wxCoord  WXUNUSED(y), wxCoord  WXUNUSED(width), wxCoord  WXUNUSED(height))
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::SetClippingRegion Call not yet implemented")); return ; };

        void SetPalette(const wxPalette&  WXUNUSED(palette))
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::SetPalette Call not yet implemented")); return ; };
        ...
        void SetLogicalFunction(int  WXUNUSED(function))
            { wxASSERT_MSG (false, wxT("MusSVGFileDC::SetLogicalFunction Call implemented")); return ; };
