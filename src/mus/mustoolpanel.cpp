...
BEGIN_EVENT_TABLE(WgToolPanel,wxPanel)
	EVT_COMMAND( ID_MS_BT_INSERT, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnChangeMode )
    EVT_COMMAND_RANGE( ID_MS_BT_NOTES, ID_MS_BT_SYMBOLES, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnChangeTool )
    EVT_COMMAND_RANGE( ID_MS_BT_N0, ID_MS_BT_N7, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnNote )
    EVT_COMMAND_RANGE( ID_MS_BT_R0, ID_MS_BT_CT, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnNote )
	EVT_COMMAND_RANGE( ID_MS_BT_LG_D, ID_MS_BT_UPDOWN, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnNote )
    EVT_COMMAND_RANGE( ID_MS_BT_G1, ID_MS_BT_F5, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnKey )
    EVT_COMMAND_RANGE( ID_MS_BT_MTPP, ID_MS_BT_M2, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnSign )
    EVT_COMMAND_RANGE( ID_MS_BT_PNT, ID_MS_BT_BAR, wxEVT_COMMAND_BUTTON_CLICKED, WgToolPanel::OnSymbole )
END_EVENT_TABLE()
    ...
    wxPanel( parent, id, position, size, style )
{
	...
	m_rows[MUS_TOOLS_CLEFS] = new WgToolRow( this, -1, MUS_TOOLS_CLEFS );
	m_rows[MUS_TOOLS_CLEFS] = new WgToolRow( this, -1, MUS_TOOLS_CLEFS );
	m_rows[MUS_TOOLS_SIGNS] = new WgToolRow( this, -1, MUS_TOOLS_SIGNS );
	m_rows[MUS_TOOLS_OTHER] = new WgToolRow( this, -1, MUS_TOOLS_OTHER );

	m_rows[MUS_TOOLS_CLEFS]->Show( true );
	...
	m_previous_tools = MUS_TOOLS_CLEFS;

	SetTools( MUS_TOOLS_CLEFS, true );
...
void WgToolPanel::OnChangeTool( wxCommandEvent &event )
{
    ...
    switch ( event.GetId() )
    {
    case (ID_MS_BT_NOTES): value = MUS_TOOLS_CLEFS; break;
