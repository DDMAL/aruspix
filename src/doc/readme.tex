...
This library is available pre-compiled. Just ensure that the library you've downloaded has a file structure that matches the following example:
\begin{verbatim}
\imlib
...
After downloading Torch, follow the instructions provided on the Torch website for compiling the library on Windows. Be sure to name the project "Torch3". \begin{verbatim}http://www.torch.ch/matos/w_install.pdf \end{verbatim}
