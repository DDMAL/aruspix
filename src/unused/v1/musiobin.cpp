...
#define #AX1_CUSTOS 12

//----------------------------------------------------------------------------
// MusFileOutputStream
//----------------------------------------------------------------------------

MusBinOutput::MusBinOutput( MusDoc *file, wxString filename, int flag ) :
...
MusBinInput::MusBinInput( MusDoc *file, wxString filename, int flag ) :
