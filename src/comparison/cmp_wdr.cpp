...
wxSizer *WindowFunc6( wxWindow *parent, bool call_fit, bool set_sizer )
{
    wxFlexGridSizer *item0 = new wxFlexGridSizer( 1, 0, 0 );
    item0->AddGrowableCol( 0 );
    item0->AddGrowableRow( 0 );

    wxSplitterWindow *item1 = new wxSplitterWindow( parent, ID6_SPLITTER1, wxDefaultPosition, wxDefaultSize, 0 );
...
wxSizer *CmpFunc6( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxStaticBitmap *item3 = new wxStaticBitmap( parent, ID6_PREVIEW, BitmapsFunc6( 14 ), wxDefaultPosition, wxSize(200,200) );
...
void ToolBarFunc6( wxToolBar *parent )
{
    ...
    parent->AddTool( ID6_ZOOM_OUT, wxT(""), BitmapsFunc6( 7 ), wxNullBitmap, wxITEM_NORMAL, _("Zoom out"), _("Zoom out") );
    parent->AddTool( ID6_ZOOM_IN, wxT(""), BitmapsFunc6( 8 ), wxNullBitmap, wxITEM_NORMAL, _("Zoom in"), _("Zoom in") );
    parent->AddTool( ID6_ADJUST, wxT(""), BitmapsFunc6( 9 ), wxNullBitmap, wxITEM_CHECK, _("Adjust"), _("Adjust to fit the window") );
    parent->AddTool( ID6_ADJUST_V, wxT(""), BitmapsFunc6( 10 ), wxNullBitmap, wxITEM_CHECK, _("Adjust vertically"), _("Adjust to fit the window vertically") );
    parent->AddTool( ID6_ADJUST_H, wxT(""), BitmapsFunc6( 11 ), wxNullBitmap, wxITEM_CHECK, _("Adjust horizontally"), _("Adjust to fit the window horizontally") );
    parent->AddSeparator();
    parent->AddTool( ID6_COLLATE, wxT(""), BitmapsFunc6( 6 ), wxNullBitmap, wxITEM_NORMAL, _("Collate"), _("Collate de different books") );
